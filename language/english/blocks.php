...
define("_MB_TADPLAYER_REPEAT","Repeat play");
define("_MB_TADPLAYER_DONT_REPEAT","No repeat play");
define("_MB_TADPLAYER_LIST_REPEAT","Auto replay the entire list");
define("_MB_TADPLAYER_RANDOM_PLAY","Randomly play");
