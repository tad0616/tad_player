...
//---模組狀態資訊---//
$modversion['release_date'] = '2013/11/14';
...
$modversion['blocks'][5]['file'] = "tad_play_qrcode.php";
$modversion['blocks'][5]['name'] = _MI_QRCODE_BLOCKNAME;
$modversion['blocks'][5]['description'] = _MI_QRCODE_BLOCKDESC;
$modversion['blocks'][5]['show_func'] = "tad_play_qrcode_show";
$modversion['blocks'][5]['template'] = "tad_play_qrcode.html";
